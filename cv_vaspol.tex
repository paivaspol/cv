...
% Again, the address lines must be centered over entire width of resume:
 ...
 \moveleft.5\hoffset\centerline{70 School St, Cambridge, MA 02139}
 \moveleft.5\hoffset\centerline{Email: paivaspol@gmail.com $\cdot$ Phone: (678)-800-5952}
...
\section{\small EDUCATION}
	Ph.D. in Computer Science and Engineering \hfill Aug, 2020\\
...
\section{\small WORK EXPERIENCE}
    \textbf{Senior Performance Engineer} \hfill 09/2020 - Present \\
    Akamai Technologies, Cambridge, MA\\
    \emph{Responsibilities:} I handle Akamai's top customers performance
    escalations. During an escalation, I identify inefficiencies in content
    delivery by analyzing traffic, evaluating Akamai's delivery architecture,
    and correlating end user metrics with server-side metrics.

    To improve the delivery performance, I conduct experiments to design
    data-driven solutions to improve content delivery performance for Akamai's
    top customers.
    %

    \textbf{Graduate Student Research Assistant} \hfill 9/2014 - 8/2020 \\
    Advisor: Prof. Harsha V. Madhyastha.\\
    Electrical Engineering and Computer Science Department, University of Michigan, Ann Arbor, MI
    %

    \textbf{Student Researcher} \hfill 10/2018 - 3/2019 \\
...
\section{\small PUBLICATIONS}
    \textbf{Rethinking Client-Side Caching for the Mobile Web}\\
    Ayush Goel, \underline{Vaspol Ruamviboonsuk}, Ravi Netravali, and Harsha V. Madhyastha\\
    ACM HotMobile 2021, Virtual, February 2021
    ...
    ACM SIGCOMM 2017, Los Angeles, CA, August 2017 \\
    \textbf{Presented work at IETF-101 in receipt of IRTF's ANRP award}
    ...
    ACM ASSETS 2012, Boulder, CO, October 2012
...
\section{\small RESEARCH EXPERIENCE}
  ...
  \textbf{Vroom} [SIGCOMM'17]\\
	...
	\textbf{Numerical input gestures for visually-impaired people} [ASSETS'12]\\
    \textit{Advisor: Prof. Richard Ladner \hfill 2011 - 2014}
	\begin{itemize}
    \item Designed special gestures for inputting numbers on smartphones
      by leveraging multi-touch input surface for blind smartphone users.
    \item Implemented the prototype in the form of an iOS application.
	\end{itemize}

	\textbf{Myria, Big Data as a Service} [SIGMOD'14]\\
    \textit{Advisor: Prof. Magdalena Balazinska \hfill 2012 - 2014}
	\begin{itemize}
    \item Implemented a database operator in the system.
	\end{itemize}
...
\section{\small SERVICE}
  \textbf{Reviewer}, Future Generation Computer Systems Journal (Impact Factor: 5.768), 2019 \\

\section{\small SKILLS}
  Most of my work is done in C/C++, Go, Java, JavaScript, and Python. I also
  have some experience working with Chromium's network stack, as well as,
  networking tools such as iptables and tcpdump.
